        ...
        >
          ...
          <div className="space-y-7 max-w-lg">
            ...
            <motion.p variants={item} className="text-lg text-gray-500 leading-relaxed">
              Bizone connects farmers, delivery riders, and buyers across Nigeria — all through WhatsApp. No app. No hassle. Just order and receive.
            </motion.p>
            ...
            <motion.div variants={item}>
              <Button
                size="lg"
                className="bg-green-600 hover:bg-green-700 text-white px-7 rounded-xl shadow-md shadow-green-200 group"
              >
