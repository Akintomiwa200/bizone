        ...
        <div className="flex-1 min-w-0">
          ...
          {tweet.media && tweet.media.length > 0 && (
            <div className="mb-3 rounded-2xl overflow-hidden">
              ...
              <div className={`grid gap-2 ${tweet.media.length === 1 ? 'grid-cols-1' :
                ...
                {tweet.media.map((media, index) => (
                  <div
                    key={index}
                    className={`relative ${tweet.media!.length === 3 && index === 0 ? 'row-span-2' : ''
                      }`}
                  >
                    {media.type === 'image' ? (
                      <img
          ...
          <div className="flex justify-between max-w-md">
            ...
            <Button
              ...
              className={`text-muted-foreground hover:text-green-500 hover:bg-green-500/10 ${tweet.isRetweeted ? 'text-green-500' : ''
                }`}
            >
            ...
            <Button
              ...
              className={`text-muted-foreground hover:text-red-500 hover:bg-red-500/10 ${tweet.isLiked ? 'text-red-500' : ''
                }`}
            >
