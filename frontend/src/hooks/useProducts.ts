...
export const useProducts = (initialFilters: ProductsFilter = {}) => {
  products,
    currentProduct,
    ordersLoading, // This might actually be productsLoading, but we'll use ordersLoading if that's what's exported
    ordersError, // Same here
    ordersPagination, // Same here
    fetchProducts: storeFetchProducts,
      fetchProduct: storeFetchProduct,
        createProduct: storeCreateProduct,
          updateProduct: storeUpdateProduct,
            deleteProduct: storeDeleteProduct,
              clearCurrentProduct: storeClearCurrentProduct,
  } = useStore() as any;
